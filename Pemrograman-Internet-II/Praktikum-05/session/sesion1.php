...
{
   if($_SESSION['login']== "gregorius")
   {
   echo " Anda Berhasil Login Sebagai gregorius <br>";
   $server_host="localhost";
	...
	{
		echo"Anda berhasil mendaftar dan Login dengan user ".$_SESSION['login']." bukan gregorius <br>";
	}
